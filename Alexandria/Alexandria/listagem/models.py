...
class Livro(models.Model): #tabela dos livros
    ...
    livro_serie = models.CharField(max_length = 200 , blank=True) #blank: permite texto vazio
    livro_autor = models.ForeignKey(Autor, models.CASCADE, related_name="autor") #relacionamento entre livro e autor: um autor pode escrever vários livros
